...
export const SuicidalThoughtsInfo = () => {
    return(
    <div className="wrapperSuicidalThoughts" id="suicidal-thoughts-info">
      <div className="suicidal-thoughts-info-content">
        ...
        <div className = "container-box-2">
          ...
          <ul className="useful-bullets-2">
              ...
              <li>Keep your word, do not make promises to them that you cannot keep</li>
              <li>Tell the person that they are important and that you care about them</li>
              <li>If the person is already seeking professional help, they need to inform their health care team about their suicidal thoughts</li>
              <li>If the person is not seeking professional help yet, give them the local crisis helpline number and encourage them to talk to a therapist or other professional</li>
              <li>Ask if the person has a plan and depending on their answer, you may want to limit their access to lethal means such as medication, knives, or firearms</li>
              <li>Ask the person to rate their suicidal thoughts out of 10 and continue to ask this overtime to assess their well-being</li>
